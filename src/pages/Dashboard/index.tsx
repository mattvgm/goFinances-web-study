              ...
              {transactions.map(eachTransaction => {
                return (
                  <tr key={eachTransaction.id}>
                    <td className="title">{eachTransaction.title}</td>
                    <td className={eachTransaction.type}>
                      {eachTransaction.type === 'outcome'
                        ? `- ${formatValue(eachTransaction.value)}`
                        : `${formatValue(eachTransaction.value)}`}
                    </td>
                    <td>{eachTransaction.category.title}</td>
